    ...
    return (
        <div>
            ...
            <form ref={form} onSubmit={sendEmail} className='w-10/12 mx-auto bg-slate-800 p-10 text-center'>
                ...
                <textarea className="textarea textarea-bordered mt-5 bg-slate-800 border-0 border-b-2 border-slate-900 w-full text-lg h-48 text-white" placeholder="Message" name="message" />
